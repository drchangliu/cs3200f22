...
|-----------------------------|---------------------------------------|--------------------------------|------------|
| Week 1 (22 Aug) | [Intro](http://simp.ly/p/PM0Xxj), OCaml | [OCaml 1](https://cs3110.github.io/textbook/chapters/intro/intro.html) | Complete the ["HelloWorld" exercise](starting-ocaml.md) - no credit; nothing to turn in. Due before Week 2. |
| Week 2 (29 Aug) | Functional programming basics | [OCaml 2](https://cs3110.github.io/textbook/chapters/basics/intro.html), Supplementary: [Programming in Standard ML 2.1, 2.2](http://www.cs.cmu.edu/~rwh/isml/book.pdf#chapter.2) | [PA0: Intro. to OCaml](pa/0.md) (Due by the End of Week 2, Friday Sept 2.) <br> Q0 (2 Sep) | 
